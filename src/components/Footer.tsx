      ...
      <Box bg="#6E07F3" w="100%" h="440px">
        ...
        <HStack spacing="50px" justify="center" pt="50px" pb="70px">
          <Link href="https://github.com/danctila">
            <Image boxSize="40px" src={gitLogo} alt="github logo" />
          </Link>
          <Link
            onClick={() => (window.location.href = "mailto:danctila@gmail.com")}
          >
            <Image boxSize="40px" src={emailIcon} alt="danctila@gmail.com" />
          </Link>
        </HStack>
        <Text
          fontWeight={500}
        ...
        <HStack justify="center">
          <Text fontWeight={300} fontSize="11px" color="white">
            Made with
          </Text>
